...
from env.control.BaseControl import BaseControl
from env.BaseAviary import DroneModel, BaseAviary
from env.utils import nnlsRPM
...
class SimplePIDControl(BaseControl):
    ...
    def computeControl(self,
        ...
        if target_rpy[2] != 0:
            print("\n[WARNING] ctrl it", self.control_counter,
                  "in SimplePIDControl.computeControl(), desired yaw={:.0f}deg but locked to 0. for DroneModel.HB".format(
                      target_rpy[2] * (180 / np.pi)))
